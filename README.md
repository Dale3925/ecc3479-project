...
├── outputs/
│   ├── eda/
│   │   └── [EDA figures and tables generated by src/eda.py]
│   └── primary_analysis/
│       └── [Primary analysis outputs generated by src/primary_analysis.py]
├── requirements.txt
└── README.md
...
Then read eda_report in docs and view the figures and data in outputs/eda.
...
Then read primary_analysis_report in docs and view the outputs in outputs/primary_analysis.